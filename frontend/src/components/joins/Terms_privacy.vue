<template>
  <div>
    <div class="col cont_agreement">
      <strong class="tit_article tit_article2">(주)회사는 아래의 목적으로 개인정보를 수집 및 이용하며, 회원의 개인정보를 안전하게 취급하는데 최선을 다합니다.</strong>
      ...
      <br><br>서비스 제공을 위해 필요한 최소한의 개인정보이므로 동의를 해 주셔야 서비스 이용이 가능합니다. <br>
    </div>
  </div>
</template>